...
You can find the repo for the Frontend built with react [here](https://github.com/RayG-XD/chatty).
...
```bash
git clone -b develop https://github.com/RayG-XD/chatty-backend.git
cd chatty-backend
npm install
```
...
## API Endpoints
- The actual endpoints for the application can be found inside the folder named `endpoints` [https://github.com/RayG-XD/chatty-backend/tree/develop/endpoints](https://github.com/RayG-XD/chatty-backend/tree/develop/endpoints). 
...
## You can find the frontend code [here](https://github.com/RayG-XD/chatty)
